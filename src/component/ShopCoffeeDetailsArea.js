...
import select1 from '../Assets/image/details-select-1.png' 



const ShopCoffeeDetailsArea = () => {
  return (
    <>
            ...
            <div className="row">
                ...
                <div className="col-lg-6">
                    <div className="shopInfoWrap">
                        <h2 className='title'>Coconut Milk Macchiato</h2>
                        ...
                        <div className="sizeWrap">
                            <p className='option-info-title'><b>Size Options:</b></p>
                            <div className="sizeGroup d-flex flex-wrap">
                                <label className='sizeGroupBtn'>
                                    <input type="radio" name='size' checked/>
                                    <p className='sizeBox'>
                                        <span><img src={select1} alt="" /></span>
                                        <b className='d-block'>Tall</b>
                                        8fl oz
                                    </p>
                                </label>
                                <label className='sizeGroupBtn'>
                                ...
                                <label className='sizeGroupBtn'>
                                    ...
                                    <p className='sizeBox'>
                                        <span><img src={select1} alt="" /></span>
                                        <b className='d-block'>Venite</b>
                                        24 fl oz
                                    </p>
                                </label>                               
                            </div>
                        </div>
                        <div className="sizeWrapInclude">
                            <p className='option-info-title'><b>What to Include:</b></p>
                            <div className="shopCatagorySelect coffee d-flex flex-wrap">
                                <span>
                                <select>
                                    <option value="0">Oatmilk</option>
                                ...
                                <span>
                                <select>
                                    <option value="0">Syrup pumps</option>
                                    <option value="1">Category 1</option>
                                    <option value="2">Category 2</option>
                                    <option value="3">Category 3</option>
                                </select>
                                ...
                                <span>
                                <select>
                                    <option value="0">Express Shots</option>
                                    <option value="1">Category 1</option>
                                    <option value="2">Category 2</option>
                                    <option value="3">Category 3</option>
                                </select>
...
export default ShopCoffeeDetailsArea
